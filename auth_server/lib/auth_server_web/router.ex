defmodule AuthServerWeb.Router do
  ...
  scope "/", AuthServerWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{AuthServerWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", AuthServerWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{AuthServerWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", AuthServerWeb do
    ...
    live_session :current_user,
      on_mount: [{AuthServerWeb.UserAuth, :mount_current_user}] do
